...
class DataDumpo(models.Model):
    ...
    강의평가 = models.CharField(max_length=50)
    유형 = models.CharField(max_length=50)
    ...
    강의실 = models.CharField(max_length=50)
    수용인원 = models.CharField(max_length=50)
    관심과목 = models.CharField(max_length=50)
    등록수 = models.CharField(max_length=50)
